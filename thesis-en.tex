...
cargo-semver-checks-action is implemented as a~GitHub Action, which is a~way of creating a resusable GitHub workflow.
...
(such as the name of the crate to check), which are passed to the CLI of cargo-semver-checks binary.
