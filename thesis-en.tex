...
\begin{itemize}
	...
	\item define Manifest file and lockfile
...
TODO:
\begin{itemize}
	\item explain why it is easy to break semver in Rust. Do that by giving specific, non-obvious code examples.
	\item expand this TODO with sources from which to get examples
