...
\begin{itemize}
	...
	\item the tests became more organised, uncovering some bugs
		-- previously each test source code had a lot of branch conditions that
...
(simply because cloning the user's git repo takes time and memory, requires internet connection
