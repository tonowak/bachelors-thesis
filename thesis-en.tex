...
Cargo-semver-checks is a tool designed to detect semantic versioning violations within Rust crates.
To do so, the new version of the crate undergoes multiple lint checks, which are meant to find
...
tool's practical usage and destiny, see chapter \ref{r:chapter_vision}.
