...
\begin{enumerate}
	\item discussing with our mentor (that is also the project maintainer) about
		what improvements have the highest priority,
	\item individually picking a few tasks based on our preferences,
	\item implementing the tasks
	...
	\item going through an extensive review process with our mentor
		...
		the code's readability is a strong focus in the project),
...
\begin{itemize}
	\item at the beginning, we split into two pairs and our mentor gave each of us
		three tasks to work on together and familiarize with different aspects of the existing code,
	\item to speedup the process of merging the Pull Requests,
		sometimes we first reviewed each others' code,
	\item when a user reported a bug, we often looked into the problem
		and searched for a temporary fix or the bug as soon as possible,
...
Additionally, we did weekly meetings to discuss the progress and future contributions.
