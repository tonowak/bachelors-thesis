...
\texttt{\#[non\_exhaustive]} attribute prior to its official introduction. But in order to use the
newly added attribute instead, they had to purposely make breaking changes in their crates.
