...
After several months of constant development, the tool has gained numerous new features as well as
stability and performance improvements. It has acquired recognition among the developers
over time as it became faster, easier to add to one's project and gained additional lints
preventing even more semver breaks.

During the research that we conducted in chapter \ref{r:chapter_results_popular_crates},
the tool has proven its reliability in varying conditions of the most popular Rust packages,
furthermore reaffirming the value and benefits it has to offer the developers.

After all of our contributions, the tool's ultimate goal of becoming a built-in feature of cargo
seems closer than it has ever been before. More and more users decide to add the tool to their
production processes. Moreover, it is not only the packages' maintainers, but also all of
the packages' dependants who profit from the tool's presence in the crate's repository. Thus its
actual impact and the group of beneficiaries are much greater than the number of repositories
using it may suggest.

In conclusion, the final outcome of our work has been an order of magnitude greater than
we expected. Already since the early days of our contributions we could see the constant increase
in the tool's usage as it was growing to its current, well-estabilished position in the world
of Rust. With that, we firmly believe that its future is bright and are happy to already see it
making such an impact, hoping to soon allow everyone to be fearless about running
...
The Rust community has shown great interest in using the tool -- as of May 2023,
...
\end{figure}
The release of binaries was a big change for how the tool is accessed and had its effect on
...
recent one. However, with pre-builds now available, more and more projects
...
There are multiple reasons behind this great increase in cargo-semver-checks popularity. While it
...
\begin{itemize}
	...
	\item numerous optimalizations of the tool's performance (done both by us in
...
-- there were cases where after our response users would share some useful
...
companies widely known outside the Rust community as well -- the tool has been adopted by Amazon,
Microsoft and Mozilla. Developers have even built third party integrations to bring
