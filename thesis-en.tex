	...
	\item Mieszko:
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item introducing input \texttt{manifest-path}, as requested by a user \cite{issue_action_manifest_path};
				\item introducing input \texttt{verbose}, as requested by a user \cite{issue_action_verbose};
				\item using pre-build binaries to speed up the action, as requested by a user \cite{issue_action_binaries};
	...
	\item Bartosz:
		\begin{itemize}
			...
			\item Added several new lints (trustfall queries, test crates, tests)
				...
				descript messages for the user, improved the code structure by creating smaller,
				more specialized files and made the final review process easier.
				\begin{itemize}
