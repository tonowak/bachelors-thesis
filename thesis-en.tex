...
\begin{itemize}
	...
	\item tests failing on Rust 1.67.0 due to the addition of a public \texttt{rustc} internal trait \texttt{StructuralEq} which is not relevant for the users,
	...
	\item rustdoc generation of \say{current} with dependency versions taken from \texttt{Cargo.lock} instead of the more intuitive choice of taking them from \texttt{Cargo.toml}, which made users confused,
