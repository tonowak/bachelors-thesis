...
so that one break can only be reported by one, precise lint. This is especially important because
the user must be provided with an extensive, coherent and clear information about the error
they have made.
...
\begin{itemize}
	...
	\item \texttt{... on Enum} -- \texttt{...} inlines the query to the specified kind of items,
		in this case Enums,
