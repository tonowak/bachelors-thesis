...
\say{current} and \say{baseline} codes) and a file containing the Trustfall query results
for this sourcecode and lint.
We have replaced this system with a new one that contains numerous \say{crate pairs}
(two separate directories called \say{current} and \say{baseline} crates with their own
manifests and source codes) and Trustfall query results for each lint over all of the
