	...
	\item Mieszko:
		\begin{itemize}
			...
			\item Reported a bug where the precompiled tool crashed on Windows machines \cite{issue_fail_on_windows}.
				Added a CI job exposing the issue \cite{pr_fail_on_windows} \cite{pr_ci_windows_comment}.
			...
			\begin{itemize}
				\item creating a test repository \cite{repo_action_tests} and using it to add CI workflow that tests
...
\end{itemize}
	...
	\item Mieszko and Bartosz:
		\begin{itemize}
			...
			\item Designed and implemented new adapter schema for handling attributes
