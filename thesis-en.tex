...
All in all, we found semver violations in slightly \textbf{more than 1 in 6 crates}
...
\begin{table}[h]
	...
	\begin{tabular}{|
		...
		\hline
			{\textbf{name of the lint in cargo-semver-checks}} &
			{\textbf{number of individual instances where the lint found a violation}} &
			{\textbf{number of releases where the lint found a violation}} &
			{\textbf{number of crates where the lint found a violation}} \\
		\hline
