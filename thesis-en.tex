...
of the same crate:
\begin{itemize}
	\item baseline -- the existing version that defines a public API,
	\item current -- the modified version of baseline that is vulnerable to breaking semver,
\end{itemize}
...
lint. This is especially important because the user must be provided with an extensive, coherent
