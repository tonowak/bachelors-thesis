...
Interestingly, some changes that are breaking according to today's conventions are
commonly accepted as non-breaking by the majority of Rust community. This is because close
imitations of some language features were used by the developers prior to their official
introduction. To use the novelties, they had to purposely make breaking changes in their crates.
Because of this, checking older releases with current Rust standards can occasionally produce
unintuitive results.
