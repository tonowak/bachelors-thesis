...
% TODO -- merge this as-is, I will add the ref-links in a separate PR once this is part of main so
%		  that they will actually work in the PR.
...
% TODO -- depending on the final layout, it may be worth it to cut this image in half.
...
and the releases without the witnesses are \textit{not} included in the statistics in section \ref{section_results_semver_crater}
	...
	\item Tomasz \cite{responsibilities-tomasz}:
		\begin{itemize}
			...
			\item Developed \texttt{semver-crater} that runs cargo-semver-checks on the most popular crates
				(see section \ref{section_results_semver_crater})
...
During the research that we conducted in chapter \ref{r:chapter_results_popular_crates},
...
% 	\item over 7 400 downloads during our contributions, after the release of pre-built executable
% 		binaries (period of 3 months).
% \end{itemize}
% \begin{figure}[h]
% 	\centering
