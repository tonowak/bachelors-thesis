...
Throughout our contribution to the project we managed to fix the following bugs:
\begin{itemize}
	...
	\item incorect baseline version printed when the baseline was specified through
		a path to the manifest,
	\item trustfall-rustdoc-adapter incompatibility with new version of rustdoc v23
		which stopped exporting inlined items of external crates,
	\item running the tool resulting in update of the Cargo.lock file,
	\item CI job wrongly checking the exit code in one of
		the integration tests,
	\item broken link appearing in the tool's output,
...
\begin{itemize}
	...
	\item lack of detailed information in the help messages of the tool,
	...
	\item the tool printing some internal data while cheching the clap
		crate,
