...
\textbf{in 470 of them we found one or more semver violations}.
This means that on average every 1 in 30 releases that we checked had at least one semver violation.
...
for example, a release could have removed multiple functions. Ignoring multiple instances
...
proving that a particular release indeed violates semver.
