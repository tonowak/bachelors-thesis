...
\begin{itemize}
	\item cargo-semver-checks tool is downloaded as a~pre-compiled binary instead of being built from source,
...
We had one last difficulty when we tried to create witnesses for the \texttt{enum\_variant\_added} lint.
				...
				and the adapter.
                        ...
                        \begin{itemize}
                            ...
                            \item Reworked the code that handles crate configuration and adjusted
                                    ...
                                    Currently, the default behavior is to enable a~heuristically-chosen
	...
	\item Mieszko \cite{responsibilities-mieszko}:
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item introducing several new inputs \texttt{package}, \texttt{exclude}, \texttt{manifest-path},
