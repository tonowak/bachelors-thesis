...
The final impact of our work has been an order of magnitude greater than
we expected. Since the early days of our contributions, we could see the constant increase
in the tool's usage as it was growing to its current, well-estabilished position in the Rust
ecosystem. With that, we firmly believe that its future is bright and are happy to already see it
