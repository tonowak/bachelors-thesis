...
a form that is easy to analyze and compare. For this purpose, our tool uses Trustfall to parse the
output received from rustdoc into much more managable form.
...
navigate during the search, it follows consecutive filtering rules defined by the users in special
\texttt{.ron} (rusty object notation) files, named \texttt{lints}.
% TODO:
% \begin{itemize}
