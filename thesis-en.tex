...
Interestingly, some changes that are breaking according to today's conventions are still
commonly accepted as non-breaking by the majority of Rust community. This is because some language
features were already in use by the developers prior to their official introduction (such as the
\texttt{\#[non\_exhaustive]} attribute). Because of this, checking older releases with current Rust
standards can occasionally produce unintuitive results.
