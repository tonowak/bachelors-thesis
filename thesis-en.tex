...
We considered only non-yanked releases of those crates which aren't a major change
that were published after 2017-01-01. From those releases, 919 of them didn't compile on our machines
with the current version of Rust.
Thus, we considered in total 14 389 releases (which is also the number of times
...
Thus, on average we found at least one break in 1 out of 30 releases.
Those releases are in 173 different crates (out of 1000).
In total, different lints were triggered 655 times with 3305 items reported 
...
in both a human-readable and a machine-readable form.
