...
\texttt{\#[non\_exhaustive]} attribute prior to its official introduction. To then use new attribute
itself, they had to purposely make breaking changes in their crates. However, this is the case with
