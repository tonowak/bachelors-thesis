...
\end{itemize}
the tool parses them using Trustfall to introduce a layer of abstraction that remains constant
(functions, structs, enums, variants, etc.) After that, the versions are compared using all of
