...
installing cargo-semver-checks, and finally -- running it on a~crate. The aim of the GitHub Action is to simplify
this process and make it a single step that can be easily added to the workflow file.
