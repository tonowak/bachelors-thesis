...
\section{More lints that check for semver breaks}\label{r:section_new_lints}
...
\section{A new GitHub Action for the users}\label{r:section_continuous_integration_improvements}
...
\chapter{Tool's results on popular crates}\label{r:results_popular_crates}

\section{Statistics of found true-positives and bugs}\label{r:witness_generation}

\section{The process of gathering results -- semver-crater}\label{r:intro_semver_crater}
...
\section{The significance of our contributions}\label{r:section_conclusion}
...
\section{Rust community's positive response to the tool}\label{r:section_popularity_increase}
