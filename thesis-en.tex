...
We have discovered that more than 1~in~6 of the most commonly used Rust libraries have broken a~multitude
...
tool called that solves this problem. It detects changes that are
