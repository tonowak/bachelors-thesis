...
cargo-semver-checks-action is implemented as a~GitHub Action, which is a~way of creating a reusable GitHub workflow.
...
and allowed the action to be run only on Linux hosts. The V2 version of the action is implemented in a platform-independent way
using TypeScript and Node.js, which allows it to be used on all runners supported by GitHub Actions. The differences
