...
\begin{itemize}
	\item Tomasz \cite{responsibilities-tomasz}:
		\begin{itemize}
			...
			\item Wrote \texttt{semver-crater} that runs cargo-semver-checks on the most popular crates
				(see section \ref{section_results_semver_crater})
				and wrote numerous scripts for analyzing the results, e.g. for:
				\begin{itemize}
					...
					\item creating witnesses for each kind of triggered lints,
					\item checking whether the witnesses found true-positives,
					\item getting a list of items for constructing witnesses 
						for lints that checks for exhaustiveness of the pattern matching. 
				\end{itemize}
				Manually verified the found results with the rest of the team.
		\end{itemize}
