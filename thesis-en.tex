...
Interestingly, sometimes the majority of Rust community states that a certain change is not
considered as breaking. This can happen e.g. after a change is introduced in the official language
standards when the developers are used to the previous, well-settled rules and prefer to adhere to
them. Such breaks are just reported by the tool as it uses the automatically generated output,
sometimes affecting the frequency at which they are reported.
