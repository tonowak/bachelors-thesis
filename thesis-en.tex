...
% W wielu językach programowania istnieją niezliczone niuanse sprawiające, że deweloperzy
...
% Jednym z języków dotkniętych tym problemem jest Rust, który również nie posiada wbudowanego
% mechanizmu wymuszającego semantyczne wersjonowanie.

% Celem tej pracy jest przedstawienie rozwoju narzędzia dla programistów w języku Rust, które
% zmniejszaja szanse na publikację kodu nieprzestrzegającego zasad semantycznego wersjonowania.

% Istnieją również plany, aby narzędzie stało się częścią standardowego toolchainu
% deweloperskiego. Skutkowałoby to jego powszechnym użyciem i tym samym pomogłoby użytkownikom
% pakietów bezpiecznie korzystać z poprawek błędów, łatek bezpieczeństwa oraz nowych
% funkcjonalności bez obaw o zepsucie ich aplikacji przez zmiany w którymś z wykorzystanych
% pakietów.
